...
def pregaria(bot, trigger):
    ...
    if trigger.group(2):
        ...
        bot.say(u"així com nosaltres perdonem el serra_marc1 o l'adriaesc quan abusen de nosaltres.")
        bot.say(u"I no permeteu que nosaltres caiguem a la temptació del baneig,")
        bot.say(u"ans deslliureu-nos del ChanServ (que no ens deixaria se ops), dels trolls i de moltes coses més que no dic per no allargar-me.")    
        return
